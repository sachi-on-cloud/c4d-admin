                                                    ...
                                                    <tr key={data?.id} className={className}>
                                                        ...
                                                        <td>
                                                            <Chip
                                                                variant="ghost"
                                                                // color={"blue"}
                                                              value={data?.status == "CONFIRMED" ? "BOOKING CONFIRMED" : data?.status === "BOOKING_ACCEPTED" ? "DRIVER_ACCEPTED"data?.status === "ENDED" && data?.tripStatus === true ? "Completed" : data?.status === "QUOTED" && data?.followup === "FOLLOWUP" ? "Follow Up" : data?.status === "QUOTED" && data?.followup === "FOLLOWUP_COMPLETED" ? "Follow Up Completed" : data?.status}
                                                                className={`py-0.5 px-2 text-[11px] font-medium w-fit ${
