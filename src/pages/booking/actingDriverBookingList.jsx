...
export function ActingDriverBookingsList({ customerId = 0, bookingStage, onAssignDriver, onSelectBooking }) {
...
export default ActingDriverBookingsList;
