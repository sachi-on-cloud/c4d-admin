...
const ParcelPeakHourTableEdit = ({ initialParcelPeakRef , onUpdated }) => {
    const [priceData, setPriceData] = useState(initialParcelPeakRef);
    ...
    useEffect(() => {
        setPriceData(initialParcelPeakRef);
    }, [initialParcelPeakRef]);
    ...
    return (
        <>
            <div className="flex flex-row justify-between px-2 mb-2 mt-4">
                <h2 className="text-2xl font-bold mb-4">Edit  Parcel Peak Hours Table</h2>
                <Button
                    className="text-xs font-semibold text-white bg-black px-4 py-2"
                    onClick={() => handleOpenModal()}
                >
                    Add Parcel Peak Hour
                </Button>
            </div>
            <Card>
            ...
            <Dialog open={openModal} handler={handleCloseModal}>
                <DialogHeader>{isEditMode ? "Edit Parcel Peak Hour" : "Add Parcel Peak Hour"}</DialogHeader>
                <DialogBody divider>
...
export default ParcelPeakHourTableEdit;