...
import {Button,Typography,Menu,MenuHandler, MenuList} from "@material-tailwind/react";
import {FunnelIcon,CalendarDaysIcon,MapPinIcon} from "@heroicons/react/24/outline";
    ...
    <div className="mt-4 flex flex-wrap items-center justify-between gap-3 px-5 py-3 rounded-xl  bg-white">
      <div className="flex items-center gap-3">
        {tabs.map((tab) => (
          ...
          >
            <Typography color="inherit" className="font-medium text-sm capitalize">{tab.label}</Typography>
          </Button>
        ))}
      </div>

      <div className="flex items-center gap-3 text-sm">
        <Typography variant="small" className="hidden md:flex items-center gap-2 text-xs font-medium text-blue-gray-500">
        ...
        <Menu placement="bottom-end">
          <MenuHandler>
            <Button variant="outlined" size="sm" className="flex items-center gap-2 rounded-full border-blue-gray-200 px-3 py-1">
              <FunnelIcon className="h-4 w-4 text-blue-gray-600" />
              <span className="text-xs font-medium text-blue-gray-700">Filters</span>
            </Button>
          </MenuHandler>
          <MenuList className="w-64 p-3">
            <div className="mb-3">
              <div className="mb-2 flex items-center gap-2">
                <CalendarDaysIcon className="h-4 w-4 text-blue-500" />
                <span className="text-xs font-semibold uppercase text-blue-gray-400">Type</span>
              </div>
            ...
            <div className="mt-2 border-t border-blue-gray-50 pt-3">
              <div className="mb-2 flex items-center gap-2">
                <MapPinIcon className="h-4 w-4 text-amber-500" />
                <span className="text-xs font-semibold uppercase text-blue-gray-400">Zone</span>
              </div>
