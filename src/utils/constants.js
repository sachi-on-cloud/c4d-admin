...
export const ROLE_PERMISSIONS = {
    'SUPER_USER': ['Home', "Calls", 'All bookings', 'Customers', 'Vendors', 'Shop List','Inventory','Trip Master','Finance', 'Document verification','Marketing', 'Users'],
