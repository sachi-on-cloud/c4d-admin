                  ...
                  <>
                    ...
                    <span className="font-medium text-green-600">{log?.new_status || 'N/A'}</span>
                        ...
                        <>
                          ...
                          <span className="font-medium text-primary-600">
                            {log?.previousStatus === "NONE" ? "QUOTED": log?.previousStatus === 'BOOKING_ACCEPTED' ? log.previousStatus === 'DRIVER_ACCEPTED': log?.previousStatus || "N/A"}
                          </span>{" "}
                          to{" "}
                          <span className="font-medium text-green-600">
                            {log?.newStatus === "NONE" ? "QUOTED" : log?.newStatus === 'BOOKING_ACCEPTED' ? 'DRIVER_ACCEPTED' : log?.newStatus || "N/A"}
                          </span>
                  </>
                )}
                  </span>
