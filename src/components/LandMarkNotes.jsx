  ...
  return (
    <div className="flex-1 p-4 bg-gray-100">
      ...
      {!hasLandmark && (
        <div className="mb-4">
        <textarea
          className="border border-gray-200 rounded-lg p-1 mb-2 bg-white text-base h-[50px] w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
